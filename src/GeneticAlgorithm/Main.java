...
/*
 * GeneticAlgorithm.Main class implementing a genetic algorithm for optimizing delivery routes.
 ...
 * 3. GeneticAlgorithm.Fitness Evaluation - Evaluate initial population
 * 4. GeneticAlgorithm.Selection Method Setup - Configure selection and replacement
 * 5. GeneticAlgorithm.Crossover Demonstration - Show crossover operations
 * 6. Mutation Demonstration - Show mutation operations
 * 7. Evolution - GeneticAlgorithm.Main genetic algorithm loop
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // Use GeneticAlgorithm.Initializer class for population creation
        ...
        System.out.println("Choose GeneticAlgorithm.Selection Method (default: " + defaultSelType + "):");
        System.out.println("1 - Tournament GeneticAlgorithm.Selection");
        System.out.println("2 - Roulette Wheel GeneticAlgorithm.Selection");
        ...
        // GeneticAlgorithm.Replacement Strategy
        int defaultReplaceChoice = 3;
        int defaultK = 2;
        int defaultEliteCount = 2;

        System.out.println("\nChoose GeneticAlgorithm.Replacement Strategy (default: " + defaultReplaceChoice + "):");
        ...
        System.out.println("GeneticAlgorithm.Crossover probability: " + crossoverProb);
        ...
        for (int i = 0; i < crossoverResult.size(); i++) {
            ...
            System.out.println("  GeneticAlgorithm.Fitness: " + child.getFitness());
        }
        ...
        if (showGenes) {
            ...
            System.out.println("GeneticAlgorithm.Fitness: " + demoChromosome.getFitness());
        } else {
            System.out.println("Before Mutation: " + demoChromosome.getDeliverySequence() + " (GeneticAlgorithm.Fitness: " + demoChromosome.getFitness() + ")");
            demoChromosome.mutateMethod1(mutationProb);
            System.out.println("After Mutation: " + demoChromosome.getDeliverySequence() + " (GeneticAlgorithm.Fitness: " + demoChromosome.getFitness() + ")");
        }
        ...
        for (int i = 0; i < Math.min(5, population.size()); i++) {
            ...
            System.out.println("    GeneticAlgorithm.Fitness: " + individual.getFitness());
        }
        ...
        System.out.println("  GeneticAlgorithm.Fitness: " + selectedParent1.getFitness());
        System.out.println("Parent 2:");
        ...
        System.out.println("  GeneticAlgorithm.Fitness: " + selectedParent2.getFitness());        // Phase 7: GeneticAlgorithm.Main evolutionary loop - Evolve population over generations
        ...
        for (int gen = 0; gen < generations; gen++) {
            ...
            if (showDetails) {
                ...
                System.out.println("Current best: " + best.getDeliverySequence() + " (GeneticAlgorithm.Fitness: " + best.getFitness() + ")");
            }

            int operationCount = 0;
            // Create offspring through selection, crossover, and mutation
            while (offspring.size() < popSize) {
                // GeneticAlgorithm.Selection phase
                ...
                if (showDetails && operationCount < 3) {
                    ...
                    System.out.println("    GeneticAlgorithm.Fitness: " + parent1.getFitness());
                    ...
                    System.out.println("    GeneticAlgorithm.Fitness: " + parent2.getFitness());
                }

                // GeneticAlgorithm.Crossover phase
                List<Chromosome> children = crossover.crossover(parent1, parent2, crossoverProb);

                if (showDetails && operationCount < 3) {
                    System.out.println("  GeneticAlgorithm.Crossover Result:");
            ...
            if ((gen + 1) % 10 == 0 || gen == 0 || gen == generations - 1) {
                ...
                System.out.println("  Best GeneticAlgorithm.Fitness: " + currentBest.getFitness());
                System.out.println("  Best Sequence: " + currentBest.getDeliverySequence());
                System.out.println("  Population Average GeneticAlgorithm.Fitness: " + String.format("%.2f",
        ...
        System.out.println("================================================================");
        System.out.println("Best GeneticAlgorithm.Fitness Achieved: " + bestOverall.getFitness());
        ...
        System.out.println("\n=== PERFORMANCE STATISTICS ===");
        System.out.println("Average GeneticAlgorithm.Fitness: " + String.format("%.2f", avgFitness));
        System.out.println("Maximum GeneticAlgorithm.Fitness: " + String.format("%.2f", maxFitness));
        System.out.println("Minimum GeneticAlgorithm.Fitness: " + String.format("%.2f", minFitness));
        System.out.println("GeneticAlgorithm.Fitness Improvement: " + (bestOverall.getFitness() - initialBest.getFitness()));
        ...
        System.out.println("GeneticAlgorithm.Crossover Probability: " + crossoverProb);
        System.out.println("Mutation Probability: " + mutationProb);
        System.out.println("GeneticAlgorithm.Selection Method: " + (selType == 1 ? "Tournament" : "Roulette Wheel"));
        System.out.println("GeneticAlgorithm.Replacement Strategy: " + replacementStrategy.toString());
        ...
        for (int i = 0; i < Math.min(5, sortedPopulation.size()); i++) {
            ...
            System.out.println("    GeneticAlgorithm.Fitness: " + c.getFitness());
            System.out.println("    Route Time: " + c.getTotalRouteTime());
        }
        System.out.println("\nAlgorithm Effectiveness Analysis:");
        System.out.println("  Initial Best GeneticAlgorithm.Fitness: " + initialBest.getFitness());
        System.out.println("  Final Best GeneticAlgorithm.Fitness: " + bestOverall.getFitness());
        ...
        if (fitnessHistory.size() > 1) {
            ...
            System.out.println("  Average GeneticAlgorithm.Fitness Improvement per Generation: " + String.format("%.2f", convergenceRate));
        }
